package com.example.coconinoonlineshoppingapplication;
...
public class Database {
	...
	public Order createOrder(Order order) {
		...
		try {
			...
			order.setOrderDate(Date.valueOf(sdf.format(today)));
			order.setRequiredDate(Date.valueOf(formattedRequiredDate));
